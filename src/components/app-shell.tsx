...
const GROUPS: Group[] = [
...

  {
    ...
    icon: Ship,
    items: [
      { to: "/logistica/nuevo", label: "Nueva Operación", icon: Plus,
        roles: ["admin", "logistica"], match: (p) => p === "/logistica/nuevo" },
      { to: "/logistica", label: "Operaciones", icon: Ship,
        match: (p) => (p === "/logistica" || p.startsWith("/logistica/")) && p !== "/logistica/nuevo" },
    ],
  },
  {
    id: "expedientes",
  ...
  },
  {
    ...
    icon: Shield,
    roles: ["admin", "contabilidad", "finanzas", "rrhh", "operaciones", "transporte"],
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/solicitudes-pago-transferencia", label: "Pagos por Transferencia", icon: Landmark,
        roles: ["admin","finanzas","contabilidad"],
        match: (p) => p.startsWith("/admin/solicitudes-pago-transferencia") },
      { to: "/admin/registro-diario", label: "Registro de Diario", icon: ClipboardList,
        roles: ["admin","finanzas","contabilidad"],
        ...
        <div className="flex items-center gap-3 px-3 py-3">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <div className="text-[10px] uppercase tracking-wider text-sidebar-accent-foreground/90 leading-snug">Plataforma inteligente de gestión<br />y logística de cargas</div>
            </div>
          )}
        </div>
      </SidebarHeader>
