  ...
  const create = useMutation({
    mutationFn: async () => {
      const payload: any = {
        ...
        cot_numero: null,
        cot_fecha_emision: null,
        cot_fecha_vigencia: null,
        cot_notas: null,
        cot_tipo_mercancia: form.tipo_mercancia || null,
        cot_origen: form.origen || null,
        cot_destino: form.destino || null,
        cot_incoterm: form.incoterm || null,
        cot_peso_kg: num(form.peso_kg),
        cot_volumen_m3: num(form.volumen_m3),
        cot_tarifa_propuesta: num(form.tarifa_propuesta),
        cot_moneda: form.moneda || null,
      };
      ...
      <div className="p-6 max-w-xl mx-auto">
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>Solo los roles Vendedor y Administrador pueden crear órdenes.</p>
