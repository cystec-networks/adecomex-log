ALTER TABLE public.expedientes
  ADD COLUMN IF NOT EXISTS reembolso_estado text NOT NULL DEFAULT 'pendiente',
  ADD COLUMN IF NOT EXISTS reembolso_fecha_pago date;

ALTER TABLE public.expedientes
  ADD CONSTRAINT expedientes_reembolso_estado_check
  CHECK (reembolso_estado IN ('pendiente','pagado')) NOT VALID;
